...
globalkeys = gears.table.join(
    ...
    awful.key({ }, "F12", function () 
        awful.util.spawn("kitty -name scratch-term", { instance = "scratch-term" }) 
    end,
    ...
    awful.key({ modkey }, "F2", function () awful.util.spawn(editorgui1) end,
        {description = "vscodium", group = "function keys"}),
    ...
    awful.key({ modkey }, "t", function() awful.spawn.with_shell("$HOME/.config/rofi/rofi-awesome-theme-selector.sh") end,
        {description = "awesome theme  changer", group = "super"}),
    ...
    awful.key({ altkey }, "Tab", function() awful.util.spawn(os.getenv("HOME") .. "/.config/rofi/rofi-sound1.sh") end,
        {description = "rofi", group = "tag"}),
