...
local editorgui2        = "geany"
local filemanager       = "thunar"
local mailclient        = "thunderbird"
local mediaplayer1      = "spotify"
local mediaplayer2      = "rhythmbox"
...
local vmenuSound    = soundDir .. "bell.oga"
    ...
    awful.button({ }, 3, function ()
        ...
        return function ()
            if instance and instance.wibox.visible then
                ...
                instance = awful.menu.clients({theme = {width = dpi(100)}})
            end
        end
    end),
...
lain.layout.cascade.tile.offset_y      = dpi(20)
...
local myawesomemenu = {
    ...
    { "Edit  config" , "code .config/awesome"},
...
globalkeys = my_table.join(
    ...
    {description = "show menubar", group = "hotkeys"}),
    -- function ()
    ...
    awful.key({ modkey }, "F2", function () awful.util.spawn( editorgui1 ) end,
        {description =  "vs code" , group = "function keys" }),
    awful.key({ modkey }, "F3", function () awful.util.spawn( mailclient) end,
        {description = "thunderbird" ,group = "function keys" }),
    awful.key({ modkey }, "F4", function () awful.util.spawn( "gimp" ) end,
        {description = "gimp" , group = "function keys" }),
    awful.key({ modkey }, "F5", function () awful.util.spawn( "editorgui2" ) end,
    ...
    awful.key({ modkey }, "F7", function () awful.util.spawn( mediaplayer2 ) end,
        {description = "rhythmbox" , group = "function keys" }),
    awful.key({ modkey }, "F8", function () awful.util.spawn( mediaplayer1 ) end,
        {description =  "spotify" , group = "function keys" }),
    awful.key({ modkey }, "F9", function () awful.util.spawn( "rofi -show window -show-icons" ) end,
        {description = "Rofi" , group = "function keys" }),
    awful.key({ modkey }, "F10", function () awful.util.spawn( "rofi -show drun -show-icons" ) end,
        {description = "Rofi" , group = "function keys" }),
    awful.key({ modkey }, "F11", function () awful.util.spawn( "Meld" ) end,
        {description =  "Meld" , group = "function keys" }),
    awful.key({ modkey }, "F12", function () awful.util.spawn( "rofi -show drun" ) end,
        {description = "rofi" , group = "function keys" }),

    -- super + ...
    awful.key({modkey} , "a", function ()awful.spawn("xfce4-appfinder") end,
        {description  = "Xfce4 appfinder", group = "super"}),
        awful.key({ modkey }, "p", function ()awful.spawn("pamac-manager") end,
        {description  = "Add/Remove Software", group = "super"}),
    awful.key({ modkey }, "w", function () awful.util.spawn( browser1 ) end,
        {description = browser1, group = "function keys"}),
    awful.key({ modkey }, "c", function () awful.util.spawn( "caprine" ) end,
        {description = "Caprine", group = "super"}),
    ...
    awful.key({ modkey }, "q",   function() awful.spawn.with_shell( "$HOME/.config/rofi-quicklinks/quicklinks.sh" ) end,
      {description = "Rofi quick links", group = "super"}),
    ...
    awful.key({ modkey }, "x",   function() awful.spawn.with_shell( "$HOME/.config/rofipower/rofipower.sh" ) end,
    ...
    {description = "Xfce screenshot", group = "screenshots"}),
      ...
      -- Personal keybindings}}}
     awful.key({altkey}, "F1",function () awful.util.spawn( "rofi -show filebrowser -show-icons" ) end,
     {description = "Rofi filemanager", group = "util"}),
     awful.key({altkey, "Control" }, "r", function () awful.screen.focused().mypromptbox:run() end,
     {description = "run prompt", group = "super"}),
...
awful.spawn.with_shell("run thunar --daemon")
